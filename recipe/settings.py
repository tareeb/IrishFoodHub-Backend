...
SECRET_KEY = 'django-insecure-c88*5_u3qrex$%48^xvv&m!uth=c=#qb(i!*)v_dbks$3s9gip'
...
AUTHENTICATION_BACKENDS = [
    ...
    'recipeapp.backends.EmailBackend',  # Replace with your custom backend if applicable
]
